    ...
    return {
        ...
        async setup(build) {
            ...
            const javascriptTransformer = new javascript_transformer_1.JavaScriptTransformer({
                ...
                maxConcurrency: environment_options_1.maxTransformWorkers,
            ...
            build.onStart(async () => {
                ...
                try {
                    const initializationResult = await compilation.initialize(pluginOptions.tsconfig, hostOptions, {
                        sourcemap: !!pluginOptions.sourcemap,
                        preserveSymlinks,
            ...
            if (pluginOptions.fileReplacements &&
                ...
                build.onLoad({ filter: /\.json$/ }, (0, load_result_cache_1.createCachedLoad)(pluginOptions.loadResultCache, async (args) => {
                    ...
                    if (replacement) {
                        return {
                            contents: await (0, promises_1.readFile)(path.normalize(replacement)),
                            loader: 'json',
