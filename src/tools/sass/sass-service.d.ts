 ...
 */
export type Importers = Importer<'sync'> | Importer<'async'> | FileImporter<'sync'> | FileImporter<'async'> | NodePackageImporter;
export declare function isFileImporter(value: Importers): value is FileImporter;
